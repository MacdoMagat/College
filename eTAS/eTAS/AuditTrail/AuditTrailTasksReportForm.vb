...
Public Class AuditTrailTasksReportForm
    ...
    Public Sub refreshreport(query As String)
        ...
        Dim objRpt As New AuditTrailTasksReportt
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        ContainerForm.audittrail.Panel1.Controls.Add(ContainerForm.audittrailtasks)
