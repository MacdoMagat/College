...
Public Class ViewThesisReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "eTAS.ViewThesisReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedViewThesisReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ViewThesisReport = New ViewThesisReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
